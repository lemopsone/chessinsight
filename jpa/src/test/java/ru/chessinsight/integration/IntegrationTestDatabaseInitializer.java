...
public class IntegrationTestDatabaseInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        String prefix = value("test.db.schema.prefix", "TEST_DB_SCHEMA_PREFIX", "itest");
